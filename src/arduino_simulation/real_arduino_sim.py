...
class RealArduinoImplementationGenerator:
    ...
    def get_implementation_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'constraint_compliance': self.config.get('constraint_compliance', 'unknown'),
...
def test_real_arduino_implementations():
    ...
    for impl in implementations:
        ...
        try:
            ...
            print(f"✅ Success: {generation_rate:,.0f} gen/sec, {violations} violations")
    ...
    if results:
        ...
        print(f"{'Rank':<4} {'Implementation':<25} {'Speed (gen/sec)':<15} {'Violations':<10}")
        print("-" * 60)
        
        for i, result in enumerate(results, 1):
            print(f"{i:<4} {result['name']:<25} {result['generation_rate']:>10,.0f} {result['violations']:>10}")
