...
class ArduinoUnoR4WiFiMock:
    ...
    def __init__(self, seed: Optional[int] = None):
        ...
        # PWM 상태
        self.pwm_values = {pin: 0 for pin in self.specs.pwm_pins}
        ...
        print(f"Arduino Uno R4 WiFi Mock initialized")
        print(f"MCU: {self.specs.mcu_name} @ {self.specs.clock_speed_hz/1_000_000:.0f}MHz")
        print(f"SRAM: {self.specs.sram_bytes//1024}KB, Flash: {self.specs.flash_memory_bytes//1024}KB")
